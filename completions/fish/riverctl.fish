...
complete -c riverctl -x -n '__fish_riverctl_complete_arg 1' -a 'focus-view-by'          -d 'Focus the view by the search term'
complete -c riverctl -x -n '__fish_riverctl_complete_arg 1' -a 'fetch-view-by'          -d 'Fetch the view by the search term'
complete -c riverctl -x -n '__fish_riverctl_complete_arg 1' -a 'list-views'             -d 'List all the views with information'
...
complete -c riverctl -x -n '__fish_seen_subcommand_from focus-view-by'           -a 'app-id title id'
complete -c riverctl -x -n '__fish_seen_subcommand_from fetch-view-by'           -a 'app-id title id'
